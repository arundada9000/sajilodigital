...
export default function ContactPage() {
  ...
  const contactSchema = {
    ...
    "@type": "ContactPage",
    name: "Sajilo Digital Contact",
    description:
      "Get in touch with Sajilo Digital for web development and design inquiries.",
    url: "https://sajilodigital.com/contact",
  };
  ...
  return (
    <StandardLayout>
      ...
      <div className="min-h-screen bg-[#0b0f19] text-white selection:bg-cyan-500/30 overflow-x-hidden">
        ...
        <section className="py-20 px-6 overflow-hidden">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              {/* Float Card (Hidden on mobile via flex-col or similar, better to just make it an overlay) */}
        ...
        {/* Structured Data - Moved to StructuredData component */}
      </div>
    </StandardLayout>
  );
}
