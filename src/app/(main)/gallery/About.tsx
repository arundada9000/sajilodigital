    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-7xl mx-auto px-8 md:px-16 pt-32 pb-20">
        ...
        <div className="grid md:grid-cols-2 gap-16 md:gap-24">
          {/* Left Column */}
          <div
            className={`transition-all duration-1000 ease-[cubic-bezier(0.76,0,0.24,1)] delay-200 ${
              isVisible
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li
                    key={service}
                    className={`text-lg font-light transition-all duration-700 ease-[cubic-bezier(0.76,0,0.24,1)] ${
                      isVisible
          ...
          {/* Right Column */}
          <div
            className={`transition-all duration-1000 ease-[cubic-bezier(0.76,0,0.24,1)] delay-300 ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-12"
            }`}
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li
                    key={item.award}
                    className={`flex justify-between items-center border-b border-border pb-4 transition-all duration-700 ease-[cubic-bezier(0.76,0,0.24,1)] ${
                      isVisible
                        ? "opacity-100 translate-x-0"
                        : "opacity-0 translate-x-8"
                    }`}
        ...
        {/* Back to Work */}
        <div
          className={`mt-24 pt-12 border-t border-border transition-all duration-1000 ease-[cubic-bezier(0.76,0,0.24,1)] delay-700 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
          }`}
        >
          <button
