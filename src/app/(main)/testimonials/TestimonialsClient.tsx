...
const testimonials = [
    ...
    },
    {
        ...
        rating: 5,
        text: "Excellent communication throughout the project. They understood our vision for the learning platform and brought it to life. Our students love the digital experience!",
        project: "Digital Academy",
        color: "blue"
    },
    {
        name: "Anita Poudel",
        ...
        rating: 5,
        text: "From design to deployment, everything was perfect. The e-commerce site they built has helped us reach customers across Nepal. Highly recommend their technical services!",
        project: "Retail Ecosystem",
        color: "yellow"
    },
];

const stats = [
    { icon: Users, value: "100+", label: "Happy Clients", color: "text-cyan-400" },
    { icon: Building2, value: "150+", label: "Projects Completed", color: "text-purple-400" },
    { icon: TrendingUp, value: "98%", label: "Satisfaction", color: "text-green-400" },
    { icon: Star, value: "4.9/5", label: "Average Rating", color: "text-pink-400" },
];
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        {stats.map((stat, idx) => {
                            ...
                            return (
                                <motion.div key={idx} variants={itemVariants} className="text-center relative group">
                                    <div className="flex flex-col items-center">
                                        <div className={`mb-3 p-2 rounded-xl bg-white/5 ${stat.color} group-hover:scale-110 transition-transform`}>
                            ...
                            >
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex items-center gap-4 pt-6 border-t border-white/5">
                                        <div className="relative w-14 h-14 rounded-2xl overflow-hidden border border-white/10 group-hover:border-cyan-500/50 transition-colors">
                                            <Image
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-500 text-sm font-medium">{testimonial.role} at {testimonial.company}</p>
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
            ...
            <section className="py-24 px-6 bg-[#0b0f19]/50 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">Voice of Partnerships</h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                        ...
                        >
                            <Image src="/gallery/slide-1.jpg" alt="Video cover" fill className="object-cover group-hover:scale-110 transition-transform duration-1000 grayscale group-hover:grayscale-0" />
                            ...
                            <div className="absolute bottom-8 left-8">
                                <div className="text-white font-bold text-xl mb-1">Rajesh Sharma</div>
                                <div className="text-cyan-400 text-sm font-bold tracking-widest uppercase">CEO, TechVision Nepal</div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="group relative h-[350px] rounded-[50px] overflow-hidden border border-white/10 shadow-3xl cursor-pointer"
                        >
                            <Image src="/gallery/slide-2.jpg" alt="Video cover" fill className="object-cover group-hover:scale-110 transition-transform duration-1000 grayscale group-hover:grayscale-0" />
                            <div className="absolute inset-0 bg-linear-to-t from-[#0b0f19] via-transparent to-transparent opacity-60" />
                            ...
                            <div className="absolute bottom-8 left-8">
                                <div className="text-white font-bold text-xl mb-1">Priya Thapa</div>
                                <div className="text-purple-400 text-sm font-bold tracking-widest uppercase">Marketing Dir, Himalayan Ventures</div>
                            </div>
                        </motion.div>
                    </div>
                </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <h2 className="text-4xl md:text-6xl font-extrabold text-white mb-8 tracking-tight">
                                Your Vision. Our Code.<br /><span className="text-cyan-400">Pure Innovation.</span>
                            </h2>
