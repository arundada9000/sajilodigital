...
const stats = [
  ...
  { icon: Award, value: "2", label: "Awards Won", color: "text-pink-400" },
  {
    icon: Globe,
    value: "10+",
...
const values = [
  {
    ...
    description:
      "We don’t chase trends, we choose the right technology to solve real problems. Every solution is built to keep you relevant, competitive, and future-ready.",
  ...
  },
  {
    ...
    description:
      "We listen before we build. Your goals, challenges, and vision guide every decision we make, because your success is deeply personal to us.",
  ...
  },
  {
    ...
    title: "Built to Last",
    description:
      "Quality isn’t an afterthought, it’s our standard. We craft reliable, secure, and scalable solutions you can trust long after launch day.",
  ...
  },
  {
    ...
    description:
      "We grow when you grow. Through continuous learning and improvement, we help your business adapt, evolve, and thrive in a changing digital world.",
...
const timeline = [
  {
    ...
    description:
      "Stepped into the IT world with a clear vision: to build technology that solves real-world problems and empowers businesses.",
  },
  {
    year: "2022",
    title: "Building the Foundation",
    description:
      "Explored core technologies and IT infrastructure, mastering HTML5, CSS3, modern web concepts, and emerging technologies.",
  },
  {
    year: "2023",
    title: "From Learning to Creating",
    description:
      "Transitioned from learning to execution by developing practical, real-world products with meaningful impact.",
  },
  {
    year: "2024",
    title: "Empowering Others",
    description:
      "Began mentoring and collaborating on college, freelance, and real-world projects, helping ideas turn into successful solutions.",
  },
  {
    year: "2025",
    title: "National Recognition",
    description:
      "Won a National-Level Hackathon for innovation, uniqueness, and real-world applicability of the solution.",
  },
  {
    year: "2025",
    title: "Company Formation",
    description:
      "Officially registered the company, transforming passion into a professional venture focused on delivering value-driven technology.",
  },
  {
    year: "2025",
    title: "Delivering Excellence",
    description:
      "Successfully delivered high-quality products to clients, building trust, impact, and long-term partnerships.",
  },
];
            ...
            >
              ...
              <div className="space-y-6 text-gray-400 text-lg leading-relaxed">
                <p>
                  ...
                  Digital didn’t start as a company, it started as a dream. A
                  dream shaped by curiosity, late-night learning, countless
                  failures, and an unshakable belief that technology could make
                  life simpler, better, and more human.
                </p>

                <p>
                  Every step of our journey has been driven by people, learning
                  new skills, building our first products, helping friends,
                  students, and businesses turn ideas into reality. With each
                  project, we didn’t just write code; we listened, adapted, and
                  grew alongside those who trusted us with their vision.
                </p>

                <p>
                  Today, Sajilo Digital is more than a digital venture, it’s a
                  partnership built on trust, passion, and purpose. We care
                  deeply about the success of our clients, because their wins
                  are our wins. As we move forward, our promise remains the
                  same: to build technology with heart, deliver value with
                  honesty, and stand by you at every step of your digital
                  journey.
                </p>
              </div>
            </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="max-w-2xl mx-auto text-white/80 text-lg md:text-xl mb-12 leading-relaxed">
                Behind every elegant interface and powerful backend is a team of
                specialists who care deeply about the success of your mission.
              </p>
              <Link
                href="/about/team"
