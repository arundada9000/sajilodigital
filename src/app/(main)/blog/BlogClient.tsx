...
export default function BlogClient() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground selection:bg-cyan-500/30 overflow-x-hidden">
                    ...
                    {featuredPost && (
                        ...
                        >
                            <Link href={`/blog/${featuredPost.slug}`}>
                                <div className="relative grid lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-border bg-surface/40 backdrop-blur-2xl hover:border-cyan-500/30 transition-all duration-500 shadow-2xl">
                                    {/* Image Side */}
                                    <div className="relative h-72 lg:h-[450px] overflow-hidden">
                                        ...
                                        />
                                        <div className="absolute inset-0 bg-linear-to-r from-background to-transparent opacity-60 lg:block hidden" />
                                        <div className="absolute inset-0 bg-linear-to-t from-background to-transparent opacity-60 lg:hidden" />
                                    </div>

                                    {/* Content Side */}
                                    <div className="p-8 lg:p-12 flex flex-col justify-center">
                                        <div className="flex items-center gap-4 mb-6">
                                            <span className="px-4 py-1.5 rounded-full text-sm font-semibold bg-cyan-500 text-foreground shadow-[0_0_15px_rgba(6,182,212,0.5)]">
                                                Featured
                                            </span>
                                        ...
                                        <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6 leading-tight group-hover:text-cyan-400 transition-colors duration-300">
                                            {featuredPost.title}
                                        </h2>
                                        ...
                                        <div className="flex items-center justify-between mt-auto pt-8 border-t border-foreground/5">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="font-bold text-foreground text-lg leading-tight">{featuredPost.author.name}</p>
            ...
            {/* Grid Section */}
            <section className="py-20 bg-background/50 border-y border-foreground/5">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
                        <div>
                            <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-4">Latest Articles</h2>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {['All', 'Technology', 'Design', 'Development', 'Business'].map((cat) => (
                                <button
                                    key={cat}
                                    className="px-4 py-2 rounded-xl text-sm font-medium bg-foreground/5 border border-border hover:bg-accent hover:border-cyan-500/50 transition-all duration-300"
                                >
                                    {cat}
                                </button>
                            ))}
            ...
            <section className="py-32 px-6">
                <div className="max-w-5xl mx-auto">
                    <motion.div
                        ...
                        className="relative p-12 lg:p-20 rounded-[40px] overflow-hidden border border-border bg-linear-to-br from-surface to-background text-center"
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <form className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto p-2 rounded-2xl bg-foreground/5 border border-border backdrop-blur-sm">
                                <input
                                    type="email"
                                    placeholder="name@email.com"
                                    className="flex-1 bg-transparent px-6 py-4 text-foreground focus:outline-none placeholder:text-muted-foreground"
                                    required
                                />
                                <button
                                    type="submit"
