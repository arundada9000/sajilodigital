    ...
    return (
        <>
            ...
            <section className="pb-32 px-6 md:px-12 bg-background text-foreground/70">
                    <div className="max-w-4xl mx-auto prose prose-invert prose-lg prose-headings:text-foreground prose-a:text-purple-400 hover:prose-a:text-purple-300 prose-strong:text-foreground">
                    <div className="space-y-16">
                        ...
                        <div>
                            ...
                            <div className="p-6 rounded-2xl bg-surface/50 border border-border">
                                <p className="mb-4 text-muted-foreground">Permission is granted to temporarily download one copy of the materials (information or software) on Sajilo Digital's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:</p>
                        ...
                        {/* 4. Disclaimer */}
                        <div>
                            <h2 className="text-3xl font-bold mb-6 text-foreground">4. Disclaimer</h2>
                            <p className="leading-relaxed text-muted-foreground italic border-l-4 border-purple-500 pl-6 py-2 bg-gradient-to-r from-purple-900/10 to-transparent">
                        ...
                        {/* 5. Contact */}
                        <div className="p-8 rounded-3xl bg-gradient-to-br from-purple-900/20 to-blue-900/20 border border-border">
                            <h2 className="text-2xl font-bold mb-4 text-foreground">Questions regarding Terms?</h2>
