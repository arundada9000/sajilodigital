...
const ProjectDetail = () => {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      {/* Hero Image */}
      <div
        className={`relative w-full h-screen overflow-hidden transition-all duration-1000 ease-[cubic-bezier(0.76,0,0.24,1)] ${isVisible ? "opacity-100" : "opacity-0"
          }`}
      >
        <div
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <span
            className={`text-sm uppercase tracking-widest text-foreground/70 mb-4 transition-all duration-700 ease-[cubic-bezier(0.76,0,0.24,1)] ${isVisible
          ...
          <h1
            className={`text-4xl md:text-6xl lg:text-7xl font-light text-center px-8 transition-all duration-700 ease-[cubic-bezier(0.76,0,0.24,1)] ${isVisible
              ? "opacity-100 translate-y-0"
      ...
      <div className="max-w-5xl mx-auto px-8 md:px-16 py-24">
        {/* Project Info */}
        <div
          className={`grid md:grid-cols-3 gap-12 mb-24 transition-all duration-1000 ease-[cubic-bezier(0.76,0,0.24,1)] ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
            }`}
        ...
        {/* Project Description */}
        <div
          className={`mb-24 transition-all duration-1000 ease-[cubic-bezier(0.76,0,0.24,1)] ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
            }`}
      ...
      <div className="border-t border-border">
        <div className="grid md:grid-cols-2">
          ...
          <button
            onClick={() => {
              setIsVisible(false);
              setTimeout(() => router.push(`/project/${prevProject.slug}`), 300);
            }}
          ...
          <button
            onClick={() => {
              setIsVisible(false);
              setTimeout(() => router.push(`/project/${nextProject.slug}`), 300);
            }}
