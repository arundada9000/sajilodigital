...
export default function HomeHero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#050505] pt-32 pb-32 md:pt-40 md:pb-40"
    >
      {/* 3D Perspective Grid */}
      <div
      ...
      >
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-cyan-400 text-[10px] md:text-xs font-black uppercase tracking-[0.4em] mb-12 backdrop-blur-md"
        >
        ...
        <div className="relative mb-12">
          <SplitText
            text="Sajilo Digital"
            tag="h1"
            className="text-6xl md:text-[12rem] font-black italic tracking-tighter leading-[0.8] uppercase text-white"
            delay={50}
            duration={1.2}
            splitType="chars"
        ...
        <motion.p
          ...
          className="max-w-xl mx-auto text-white/40 text-lg md:text-xl font-medium leading-relaxed mb-16 px-4"
        >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-12">
          <Magnetic strength={0.2}>
            ...
            >
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-full border border-white/20 flex items-center justify-center bg-white text-black group-hover:scale-110 group-hover:shadow-[0_0_50px_rgba(255,255,255,0.2)] transition-all duration-500">
          ...
          <Magnetic strength={0.1}>
            <Link
              ...
              className="group flex flex-col items-center gap-4 transition-all"
            >
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/5 transition-all duration-500">
      ...
      <div className="absolute top-0 left-[20%] w-[1px] h-screen bg-linear-to-b from-transparent via-white/5 to-transparent pointer-events-none" />
      <div className="absolute top-0 right-[20%] w-[1px] h-screen bg-linear-to-b from-transparent via-white/5 to-transparent pointer-events-none" />
    </section>
  );
}
