                            ...
                            >
                                ...
                                {hoveredIndex === index && (
                                    ...
                                    >
                                        ...
                                        <div className="absolute bottom-0 left-0 w-full h-[1px] bg-linear-to-r from-transparent via-blue-500 to-transparent animate-shimmer" style={{ animationDirection: 'reverse' }} />
                                        ...
                                        <div className="absolute right-0 top-0 w-[1px] h-full bg-linear-to-b from-transparent via-blue-500 to-transparent animate-shimmer-v" style={{ animationDirection: 'reverse' }} />
                                    </motion.div>
                                )}
